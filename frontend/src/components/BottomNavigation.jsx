...
const BottomNavigation = () => {
  ...
  return (
    <div className='flex justify-center max-h-16 bg-gray-50 dark:bg-slate-600'>
        ...
        <div className="fixed z-50 w-full h-16 max-w-md rounded-t-xl -translate-x-1/2  border-t border-gray-200  bottom-0 left-1/2 bg-slate-200 dark:bg-slate-700 dark:border-slate-700 overflow-hidden">
            <div className="grid h-full max-w-lg grid-cols-5 mx-auto">
                ...
                <div className="flex items-center justify-center">
                    ...
                    className={`inline-flex items-center justify-center w-16 h-16 font-medium  rounded-lg hover:bg-blue-300 dark:hover:bg-slate-800 group ${location.pathname === "/entrancepage" ? "text-slate-800 dark:text-blue-500 bg-blue-300 dark:bg-slate-800" : "text-slate-700 dark:text-slate-200 bg-slate-300 dark:bg-slate-600"}`}>
